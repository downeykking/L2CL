...
class HyperTuning(object):
    ...
    def export_result(self, output_file=None):
        ...
        with open(output_file, "w") as fp:
            ...
            fp.write('---------------------------------------------Best Result-----------------------------------------\n')
            fp.write(f'best params: {(self.params2str(self.best_params))} \n')
            fp.write(
                    "Valid result:\n"
                    + dict2str(self.params2result[self.params2str(self.best_params)]["best_valid_result"])
                    + "\n"
                )
            fp.write(
                "Test result:\n"
