...
class LightGCN(GeneralGraphRecommender):
    ...
    def __init__(self, config, dataset):
        ...
        # self.edge_index1, self.edge_weight1 = dataset.get_adj_mat(enable_sparse=config["enable_sparse"])
        # self.edge_index1, self.edge_weight1 = self.edge_index1.to(self.device), None
        # # self.gcn_conv = GCNConv(self.latent_dim, self.latent_dim)
